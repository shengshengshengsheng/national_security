package com.shengsheng.police.daka;
...
public class PunchCardActivity extends BasePunchActivity implements SensorEventListener, View.OnClickListener {
    /**
     * 规定到达距离范围距离
     */
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (mDistance <= DISTANCE) {
                //显示文字
                setTextOption(mDestinationPoint, "您已在学校范围内", "#7ED321");
                //目的地图标
                ...
                setTextOption(LocationPoint, "您不在学校范围之内", "#FF6C6C");
